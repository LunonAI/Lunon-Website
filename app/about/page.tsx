  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {teamMembers.map((member, index) => (
                  <Card
                    key={index}
                    className="group hover:shadow-lg transition-all duration-300 border-border hover:border-[#522396]/30"
                  >
                    <CardContent className="p-8 text-center">
                      {/* Headshot */}
                      <div className="relative w-[120px] h-[120px] mx-auto mb-4">
                        <div className="w-full h-full rounded-full overflow-hidden border-3 border-[#522396] bg-gradient-to-br from-[#522396]/10 to-[#522396]/5">
                          <Image
                            src={member.image}
                            alt={member.name}
                            width={120}
                      ...
                      {/* Info */}
                      <h3 className="text-xl font-semibold text-foreground mb-1 group-hover:text-[#522396] transition-colors">
                        {member.name}
                      </h3>
                      <p className="text-[#522396] font-medium mb-3 text-sm">
                        {member.role}
                      </p>
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#522396]/5 hover:bg-[#522396]/10 border border-[#522396]/20 hover:border-[#522396]/40 transition-all group/linkedin"
                      >
                        <svg
                          className="w-4 h-4 text-[#522396]"
                          fill="currentColor"
                          viewBox="0 0 24 24"
                        >
                          <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                        </svg>
                        <span className="text-sm font-medium text-[#522396]">Connect</span>
                      </a>
                    </CardContent>
                  </Card>
                ))}
        ...
        {/* Bottom CTA Section */}
        <section className="bg-gradient-to-b from-white to-[#522396]/10 py-24 md:py-32">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button
                  ...
                  className="bg-[#522396] text-white hover:bg-[#45158C] shadow-lg hover:shadow-xl transition-all px-8"
                >
                  View Open Positions
                  <svg
                ...
                <a
                  ...
                  className="text-[#522396] hover:text-[#45158C] font-medium transition-colors"
                >
